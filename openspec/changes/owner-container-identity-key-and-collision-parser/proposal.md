...
- [ ] T11 回帖 #193 / aria-plugin#135 指向本 Spec; #174 留言 D-0 与 SC-3 改写征求 ack; ship 后关 #193; #135 措辞按形态 (S1 = 缺口 3 部分闭合, label 陷阱待 S2 或 tracker; S2 = 缺口 3 闭合), 缺口 1/2 均留 (文档动作, 无 SC; merge 后、归档前执行)
