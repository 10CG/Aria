...
| AD-M3-3 | Schema v2 migration (additive-first + write-time fallback transform + backfill rules) | **Decided 2026-05-05 (T3)** — see [architecture-decisions.md §AD-M3-3](../../../aria-orchestrator/docs/architecture-decisions.md) | OD-12 §Q5 实施期 | backend-architect (SQL) + qa-engineer (fixture) |
