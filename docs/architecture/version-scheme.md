...
|--------|------------|----------|----------|-----------|------|
| **Aria main repo** | `/home/dev/Aria/` | v1.7.0 | `VERSION` | 里程碑 M0-M6；MAJOR on autonomous runtime 正式发布 | 方法论 + 运行时的整体版本 |
...
| **aria-plugin** | `aria/` (子模块) | v1.28.0 | `aria/.claude-plugin/plugin.json` | MINOR on new Skill/Agent; PATCH on bug fix | 独立于 Aria main repo；**不随 Aria 2.0 同 bump** |
