...
│  │  ┌─────────┐  ┌─────────┐  ┌─────────────────────────┐   │  │
│  │  │ 30 Skill│  │ runner/ │  │ OVERALL_BENCHMARK_      │   │  │
...
| **aria-plugin-benchmarks/** | Skill 基准测试 | 30 Skill 评估套件、自动化 runner、结果数据 | .claude/skills/ 定义 |
...
| 1.5.0 | 2026-03-16 | 基准测试体系：新增 aria-plugin-benchmarks/ (30 Skill 评估套件 + 自动化 runner)；可测试性增强 |
