...
[![Plugin Version](https://img.shields.io/badge/Plugin-v1.46.5-blue)](https://github.com/10CG/aria-plugin)
...
├── aria/                       # Aria 플러그인 (서브모듈)
│   ├── skills/                 # Skills 41개 (사용자용 34개 + 내부용 7개)
...
Plugin Version:   1.46.5 (aria-plugin, 41 Skills + 11 Agents)
