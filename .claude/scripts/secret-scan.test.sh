...
#
# Run: ./.claude/scripts/secret-scan.test.sh
...
expect_redact "Stripe live secret"   "stripe-live-secret"  "STRIPE_SECRET_KEY=sk_live""_51HabcXYZdefGHIjklMNOpqr"  # adjacent-string-concat obfuscates literal pattern to bypass remote secret scanners (GitHub etc); bash concatenates at exec time
...
expect_redact "Slack webhook"        "slack-webhook"       "https://hooks.""slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX"  # adjacent-string-concat obfuscates literal pattern to bypass remote secret scanners
